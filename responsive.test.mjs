...
assert.match(html, /serverUrl/);
assert.match(html, /roomCode/);
assert.match(html, /new WebSocket/);
assert.match(html, /sendOnlineAction/);
assert.match(html, /applyOnlineAction/);
assert.match(html, /wss:\/\/teams-massachusetts-mirror-shipped\.trycloudflare\.com/);
